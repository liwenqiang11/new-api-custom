...
*/
import { ANTIGRAVITY_MODELS, CHANNEL_TYPES } from '../constants'
...
export const CHANNEL_TYPE_CONFIGS: Record<number, ChannelTypeConfig> = {
  ...
  58: {
    ...
    hints: {
      baseUrl: 'Default: https://cloudcode-pa.googleapis.com/v1internal',
      key: 'OAuth JSON with access_token',
      models: ANTIGRAVITY_MODELS.join(','),
    },
  },
}
