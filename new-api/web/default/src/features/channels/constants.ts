...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  57: 'Paste Codex auth JSON (tokens.id_token / access_token / refresh_token / account_id)',
  58: 'Paste Antigravity OAuth JSON credential (access_token / refresh_token / email)',
}
