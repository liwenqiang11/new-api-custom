...
func TestRemoveDisabledFieldsRemovesResponsesImageGenerationTool(t *testing.T) {
	input := `{
		"model":"gpt-5.5",
		"input":[{
			"role":"user",
...
func TestRemoveDisabledFieldsAllowsResponsesImageGenerationTool(t *testing.T) {
	input := `{
		"model":"gpt-5.5",
		"tools":[{"type":"image_generation","quality":"low"}]
	}`
	settings := dto.ChannelOtherSettings{
		AllowResponsesImageGenerationTool: true,
	}
...
func TestRemoveDisabledFieldsRemovesOnlyResponsesImageGenerationTool(t *testing.T) {
	input := `{
		"model":"gpt-5.5",
		"tools":[{"type":"image_generation","quality":"low"}]
	}`
	...
	assertJSONEqual(t, `{"model":"gpt-5.5"}`, string(out))
}
