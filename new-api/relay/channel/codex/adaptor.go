...
func (a *Adaptor) ConvertOpenAIResponsesRequest(c *gin.Context, info *relaycommon.RelayInfo, request dto.OpenAIResponsesRequest) (any, error) {
	...
	// Codex backend only accepts streaming responses. Non-streaming clients are
	// handled by the compatibility layer when needed.
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, req *http.Header, info *relaycommon.RelayInfo) error {
	...
	if accessToken == "" {
		return errors.New("codex channel: tokens.access_token is required")
	}
	if accountID == "" {
		return errors.New("codex channel: tokens.account_id is required")
	}
