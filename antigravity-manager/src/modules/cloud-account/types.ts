...
export interface CloudQuotaWindowInfo {
  percentage: number;
  resetTime: string;
}
...
export interface CloudQuotaModelInfo {
  percentage: number;
  resetTime: string;
  weekly?: CloudQuotaWindowInfo;
  five_hour?: CloudQuotaWindowInfo;
  quota_windows?: {
    weekly?: CloudQuotaWindowInfo;
    five_hour?: CloudQuotaWindowInfo;
  };
...
export const CloudQuotaWindowInfoSchema = z.object({
  percentage: z.number(),
  resetTime: z.string(),
});
...
export const CloudQuotaModelInfoSchema = z.object({
  percentage: z.number(),
  resetTime: z.string(),
  weekly: CloudQuotaWindowInfoSchema.optional(),
  five_hour: CloudQuotaWindowInfoSchema.optional(),
  quota_windows: z
    .object({
      weekly: CloudQuotaWindowInfoSchema.optional(),
      five_hour: CloudQuotaWindowInfoSchema.optional(),
