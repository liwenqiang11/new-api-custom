...
export interface QuotaApiResponse {
  models: Record<
    string,
    {
      quotaInfo?: { remainingFraction?: number; resetTime?: string } & Record<string, unknown>;
      weeklyQuotaInfo?: { remainingFraction?: number; resetTime?: string };
      weeklyQuota?: { remainingFraction?: number; resetTime?: string };
      quotaInfoWeekly?: { remainingFraction?: number; resetTime?: string };
      fiveHourQuotaInfo?: { remainingFraction?: number; resetTime?: string };
      fiveHourQuota?: { remainingFraction?: number; resetTime?: string };
      quotaInfo5h?: { remainingFraction?: number; resetTime?: string };
      quotaInfos?: Record<string, { remainingFraction?: number; resetTime?: string } | undefined>;
      displayName?: string;
